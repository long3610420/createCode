...
public class HbmMaker {
	...
	public void createHbmFile(String adress, Table table) throws Exception {
		...
		FileUtil.writeFile(adress + "\\" + className + ".hbm.xml",
				content.toString());
	}
	...
	private String getProperties(List<Column> columns, List<String> pk) {
		...
		for (Column column : columns) {
			if (!column.isPk()) {
				...
				properties.append("type=\"" + StringUtil.changeFullType(column)
						+ "\">\n ");
				properties.append("			<column name=\"" + column.getName()
						+ "\" ");
				properties.append(getLength(column));
				properties.append(" />\n");
